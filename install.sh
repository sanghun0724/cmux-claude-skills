...
echo ""
echo "  2. Claude Code Notification 훅 등록 (선택):"
echo "     hooks/cmux-notify.mjs 를 ~/.claude/hooks/ 에 복사하고"
echo "     ~/.claude/settings.json 의 Notification 훅에 추가하세요."
echo "     자세한 내용은 README.md 참고."
echo ""
echo "  3. Claude Code 플러그인으로 설치 (선택):"
